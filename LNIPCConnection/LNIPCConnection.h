...
#import <LNIPCConnection/LNIPCBase.h>
...
@interface LNIPCInterface : NSObject

/// Factory method to get an LNIPCInterface instance for a given protocol.
...
// This object is the main configuration mechanism for the communication between two processes. Each LNIPCConnection instance has a private thread. This thread is used when sending messages to objects and blocks.
@interface LNIPCConnection : NSObject

+ (instancetype)new NS_UNAVAILABLE;
- (instancetype)init NS_UNAVAILABLE;


/// Initialize a LNIPCConnection that will register and serve the specified service name.
/// @param serviceName The service name to register
- (instancetype)initWithServiceName:(NSString*)serviceName;

/// Initialize a LNIPCConnection that will connect to specified already-registered service name.
/// @param serviceName The service name to connect to
- (instancetype)initWithRegisteredServiceName:(NSString*)serviceName LNIPC_DEPRECATED_API("Use initWithServiceName:");
...
///
/// The invalidationHandler property is cleared after the connection becomes invalid. This is to mitigate the impact of a retain cycle created by referencing the LNIPCConnection instance inside this block.
...
@property(retain, nonatomic) LNIPCInterface *exportedInterface;
...
@property(retain, nonatomic) LNIPCInterface *remoteObjectInterface;
